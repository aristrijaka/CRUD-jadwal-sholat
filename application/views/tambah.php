...
<body id="page-top">
        ...
        <div class="container-fluid">
          ...
          <p class="mb-4"></a>.</p>
           ...
           <form action="simpan_jadwal" method="get"> 
            ...
            terbit :<br> <input type="text" name="terbit" ><br>
            dhuha :<br> <input type="text" name="dhuha" ><br>
            dzuhur :<br> <input type="text" name="dzuhur" ><br>
            ashar :<br> <input type="text" name="ashar" ><br>
            magrib :<br> <input type="text" name="magrib" ><br>
            isya :<br> <input type="text" name="isya" ><br> 
  ...
  <!-- Page level plugins -->
  <script src="<?php echo $baseurl; ?>assets/vendor/chart.js/Chart.min.js"></script>

  <!-- Page level custom scripts -->
  <script src="<?php echo $baseurl; ?>assets/js/demo/chart-area-demo.js"></script>
  <script src="<?php echo $baseurl; ?>assets/js/demo/chart-pie-demo.js"></script>
